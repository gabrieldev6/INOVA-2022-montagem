...
// MAC da Shield Ethernet
byte mac[] = {
  0xDA, 0xAD, 0xBE, 0xEF, 0xFC, 0xAA
};

// Define o endereço IP fixo a ser utilizado na rede.
...
// Conectar a saída serial do usuário em 11.
SoftwareSerial SSU(8, 7); // RX, TX
